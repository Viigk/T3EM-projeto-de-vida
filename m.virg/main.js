...
const tempoObjetivo5 = new Date("2024-02-01T00:00:00");
const tempoObjetivo6 = new Date("2024-02-01T00:00:00");
...
function calculaTempo(tempoObjetivo) {
    ...
    if (tempoFinal > 0){
        return [meses,semanas,dias,horas,minutos,segundos];
    } else {
        return [0,0,0,0,0,0];
    }
}
...
function atualizaCronometro(){
    ...
    document.getElementById("meses"+i).textContent = calculaTempo(tempos[i])[0];
    document.getElementById("semanas"+i).textContent = calculaTempo(tempos[i])[1];
